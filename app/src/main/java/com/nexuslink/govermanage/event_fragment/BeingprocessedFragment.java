...
public class BeingprocessedFragment extends Fragment {

    private List<EventModel> events;   // 展示简要事件列表
    private RecyclerView eventsRecycler;
    private List<EventBean.DataBean> eventList = new ArrayList<>(); // 完整事件
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        for (int i = eventList.size() - 1; i >= 0 ; i--) {
                            if (eventList.get(i).getStatus() == 2) {
