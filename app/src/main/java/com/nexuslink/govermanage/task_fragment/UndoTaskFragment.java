...
public class UndoTaskFragment extends Fragment {
    ...
    // {"state":403,"info":"no enough power","data":[]}
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        progressDialog.show();
        OkHttpUtils.post()
                .url(Const.url + "/public/index.php/index/Work/missionList")
...
//                            if (task.getData().get(i).getMission_type() == 0) {
//                                tasks1.add(task.getData().get(i));
//                                Log.d("kkkkkkkkk", task.getData().get(i).toString());
//                            }
//                        }
...
//        String s = "\\u548c\\u6b23\\u5bb6\\u56ed\\u793e\\u533a\\u5c45\\u59d4\\u4f1a";
//        String str = UicodeBackslashU.unicodeToCn(s);
//        Log.d("UndisposedFragment1", str);
